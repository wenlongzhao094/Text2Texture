...
exp_name = '2-stylegan-GD-with-sent_embed'
...
cmd_str = 'CUDA_VISIBLE_DEVICE=0 python main_stylegan3.py --cfg cfg/texture.yml --out_path %s --model_path %s --gpu 0' % (out_path, model_path)
