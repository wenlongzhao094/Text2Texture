...
from metric_learning.layers.img_encoder import ResnetEncoder
from metric_learning.layers.sentence_encoder import make_encoder
from metric_learning.layers.util import print_tensor_stats
...
class TripletMatch(nn.Module):
    ...
    def get_text_embeddings(self, pos_sents):
